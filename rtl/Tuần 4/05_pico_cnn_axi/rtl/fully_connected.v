...
module fully_connected
    ...
    localparam signed [ACC_WIDTH-1:0] OUT_MAX_SCALED = 26'sd2047;
    localparam signed [ACC_WIDTH-1:0] OUT_MIN_SCALED = -26'sd2048;
    ...
    reg signed [ACC_WIDTH-1:0] calc_out_tmp0, calc_out_tmp1, calc_out_tmp2, calc_out_tmp3,
    ...
    wire signed [ACC_WIDTH-1:0] calc_out;
    ...
    initial
    begin
        $readmemh("data/fc_weight.mem", weight);
        $readmemh("data/fc_bias.mem", bias);
    end
    ...
    assign calc_out_scaled = calc_out >>> 7;
    assign data_out =
        (calc_out_scaled > OUT_MAX_SCALED) ? 12'sh7ff :
        (calc_out_scaled < OUT_MIN_SCALED) ? 12'sh800 :
                                             calc_out_scaled[11:0];
