...
module conv2_calc
    #(
        parameter WEIGHT_1 = "data/conv2_weight_11.mem",
    ...
    (
        ...
        output wire signed [13:0] conv_out_calc,
        output wire               valid_out_calc
    );

    localparam ACC_WIDTH = 24;
    localparam signed [ACC_WIDTH-1:0] OUT_MAX_SCALED = 24'sd8191;
    localparam signed [ACC_WIDTH-1:0] OUT_MIN_SCALED = -24'sd8192;

    wire signed [ACC_WIDTH-1:0] calc_out, calc_out_1, calc_out_2, calc_out_3;
    wire signed [ACC_WIDTH-1:0] calc_out_scaled;

    reg signed [7:0] weight_1 [0:24];
    reg signed [7:0] weight_2 [0:24];
    reg signed [7:0] weight_3 [0:24];

    reg signed [ACC_WIDTH-1:0] calc_out_1_tmp0, calc_out_1_tmp1, calc_out_1_tmp2, calc_out_1_tmp3,
    ...
    reg signed [ACC_WIDTH-1:0] calc_out_2_tmp0, calc_out_2_tmp1, calc_out_2_tmp2, calc_out_2_tmp3,
    ...
    reg signed [ACC_WIDTH-1:0] calc_out_3_tmp0, calc_out_3_tmp1, calc_out_3_tmp2, calc_out_3_tmp3,
    ...
    assign calc_out_scaled = calc_out >>> 6;
    assign conv_out_calc =
        (calc_out_scaled > OUT_MAX_SCALED) ? 14'sh1fff :
        (calc_out_scaled < OUT_MIN_SCALED) ? 14'sh2000 :
                                             calc_out_scaled[13:0];
