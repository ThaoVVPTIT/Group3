...
module conv2_layer
    ...
    wire signed [14:0] conv2_biased_1, conv2_biased_2, conv2_biased_3;
    ...
    conv2_calc
    #(
        .WEIGHT_1("data/conv2_weight_11.mem"),
        .WEIGHT_2("data/conv2_weight_12.mem"),
        .WEIGHT_3("data/conv2_weight_13.mem")
    )
    conv2_calc_1
    (
        .clk(clk),
    ...
    conv2_calc
    #(
        .WEIGHT_1("data/conv2_weight_21.mem"),
        .WEIGHT_2("data/conv2_weight_22.mem"),
        .WEIGHT_3("data/conv2_weight_23.mem")
    )
    conv2_calc_2
    (
        .clk(clk),
    ...
    conv2_calc
    #(
        .WEIGHT_1("data/conv2_weight_31.mem"),
        .WEIGHT_2("data/conv2_weight_32.mem"),
        .WEIGHT_3("data/conv2_weight_33.mem")
    )
    conv2_calc_3
    (
        .clk(clk),
    ...
    initial
    begin
        $readmemh("data/conv2_bias.mem", bias);
    end
    ...
    assign conv2_biased_1 =
        {{2{conv_out_1[13]}}, conv_out_1[13:1]} +
        {{3{exp_bias[0][11]}}, exp_bias[0]};
    assign conv2_biased_2 =
        {{2{conv_out_2[13]}}, conv_out_2[13:1]} +
        {{3{exp_bias[1][11]}}, exp_bias[1]};
    assign conv2_biased_3 =
        {{2{conv_out_3[13]}}, conv_out_3[13:1]} +
        {{3{exp_bias[2][11]}}, exp_bias[2]};

    assign conv2_out_1 =
        (conv2_biased_1 > 15'sd2047) ? 12'sh7ff :
        (conv2_biased_1 < -15'sd2048) ? 12'sh800 :
                                        conv2_biased_1[11:0];
    assign conv2_out_2 =
        (conv2_biased_2 > 15'sd2047) ? 12'sh7ff :
        (conv2_biased_2 < -15'sd2048) ? 12'sh800 :
                                        conv2_biased_2[11:0];
    assign conv2_out_3 =
        (conv2_biased_3 > 15'sd2047) ? 12'sh7ff :
        (conv2_biased_3 < -15'sd2048) ? 12'sh800 :
                                        conv2_biased_3[11:0];
