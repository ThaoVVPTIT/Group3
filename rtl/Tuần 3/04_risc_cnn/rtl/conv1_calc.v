...
module conv1_calc
    ...
    initial
    begin
        $readmemh("data/conv1_weight_1.mem", weight_1);
        $readmemh("data/conv1_weight_2.mem", weight_2);
        $readmemh("data/conv1_weight_3.mem", weight_3);
        $readmemh("data/conv1_bias.mem", bias);
    end
